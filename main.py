...
def main():
    runMetricsTests(Constants.PERIODIC_JAMMING, True, True, Constants.MAJORITY_RULE_ISOLATION_FOREST, Constants.WINDOW_SIZE)
...
def runGroundTruthTests(testType):
    tcl = TestCaseLauncher(Constants.N_ESTIMATORS, Constants.MAX_SAMPLES, Constants.CONTAMINATION, Constants.NORMAL_TRAFFIC_SIZE, Constants.CONSTANT_JAMMING_SIZE, Constants.PERIODIC_JAMMING_SIZE)
...
def runTimeTests(testType, logResults, plotResults):
    ...
    tcl = TestCaseLauncher(Constants.N_ESTIMATORS, Constants.MAX_SAMPLES, Constants.CONTAMINATION, Constants.NORMAL_TRAFFIC_SIZE, jamming_traffic_size, jamming_traffic_size)
